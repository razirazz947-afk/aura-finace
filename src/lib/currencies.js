export const worldCurrencies = [
  ...
  { code: 'ANG', name: 'Netherlands Antillean Guilder', country: 'Netherlands Antilles' },
  ...
  { code: 'BMD', name: 'Bermudan Dollar', country: 'Bermuda' },
  ...
  { code: 'BTC', name: 'Bitcoin', country: 'Global' },
  ...
  { code: 'CZK', name: 'Czech Republic Koruna', country: 'Czech Republic' },
  ...
  { code: 'ILS', name: 'Israeli New Sheqel', country: 'Israel' },
  ...
  { code: 'MKD', name: 'Macedonian Denar', country: 'Macedonia' },
  ...
  { code: 'VEF', name: 'Venezuelan Bolívar', country: 'Venezuela' },
  ...
  { code: 'XAF', name: 'CFA Franc BEAC', country: 'Central African Republic' },
  { code: 'XCD', name: 'East Caribbean Dollar', country: 'East Caribbean' },
  { code: 'XOF', name: 'CFA Franc BCEAO', country: 'West African' },
  { code: 'XPF', name: 'CFP Franc', country: 'French Territories' },
